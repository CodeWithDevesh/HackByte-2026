...
class WeaponDetectionModel:
    ...
    def ensure_vision_resources(self) -> None:
        ...
        # 🔥 IMPORTANT: use nano model for Pi
    ...
    def process_frame(self, frame: np.ndarray, *, draw_camera_hint: bool = True) -> None:
        ...
        # 🔥 SAME PATTERN AS FACE MODEL (CRUCIAL)
        if self._process_this_frame:
            ...
            # -------- ALERT LOGIC (SAME STYLE AS FACE MODEL) --------
            if weapon_found:
        ...
        # 🔥 FRAME SKIPPING (CRITICAL FOR PI)
    ...
    def run(self, list_cameras: bool = False) -> None:
        ...
        # 🔥 FORCE LOW RES (VERY IMPORTANT)
        cap.set(cv2.CAP_PROP_FRAME_WIDTH, 320)
        cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 240)

        print("Starting weapon detection (Pi optimized)...")
